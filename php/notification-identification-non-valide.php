...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/identification/notification-identite-a-valider.css">
                ...
                <div class="right-validation-identite">
                    <div class="wrap-main-content-page">
                        <div class="body-main-content-page etape2">
                            <div class="wrap-body-main-content-page">
        
                                    <div class="wrap-formulaire-projet">
                                       <div class="wrap-content-validation-form">
                                           <div class="bg-top-icon danger"><div class="progress-icon"><i class="fas fa-xmark"></i></div></div>
                                            
                                            <div class="texte-before-validation-code">
                                                
                                                <p class="nom-user">KAMDEM SIMO Belmond Euphraim</p><p><strong>Votre dossier n'a pas été approuvé. </strong><br> Bien vouloir vous conformer au reglement de la plateforme!  
                                                    <strong>Besoin d'assistance ?</strong><a href="contact.html"><span>&nbsp;Nous contacter</span></a> 
                                                </p>
                                            </div>

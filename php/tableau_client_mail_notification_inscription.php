    ...
    <div style=" font-size:14px; background-color:#EEEEEE;">
        <div class="email-contain" style="color: #3a3a3a;">
            <div style="">
                ...
                <img src="https://falamoi.com/static/img/logo.png" height="80" />
                </div>
                        ...
                        <div class="container_information">
                            <ul class="list_parent" style="list-style: none; padding-inline-start: 0; line-height:1.5em">
                                <li class="list_child" style="border-bottom: 1px dashed #d4d4d4; display: flex; align-items: center; color: grey;">
                                    ...
                                    <span class="detail" style="text-transform:capitalize; font-weight:bold">000  </span>
                                </li>
                                <li class="list_child" style="border-bottom: 1px dashed #d4d4d4; display: flex; align-items: center; color: grey;">
                                    <span style="margin-right: 10px;">Date et heure:</span>
                                    <span class="detail" style="text-transform:capitalize; font-weight:bold">04 Octobre 2024</span>
                                </li>

                                <li class="list_child" style="border-bottom: 1px dashed #d4d4d4; display: flex; align-items: center; color: grey;">
                                    <span style="margin-right: 10px;">Username  :</span>
                                    <span class="detail" style="text-transform:capitalize; font-weight:bold">Lastars</span>
                                </li>
                                <li class="list_child" style="border-bottom: 1px dashed #d4d4d4; display: flex; align-items: center; color: grey;">
                                    <span style="margin-right: 10px;">Nom  :</span>
                                    <span class="detail" style="text-transform:capitalize; font-weight:bold">KAMDEM</span>
                                </li>
                                <li class="list_child" style="border-bottom: 1px dashed #d4d4d4; display: flex; align-items: center; color: grey;">
                                    <span style="margin-right: 10px;">Pr&eacute;nom  :</span>
                                    <span class="detail" style="text-transform:capitalize; font-weight:bold">Belmond</span>
                                </li>


                                <li class="list_child" style="border-bottom: 1px dashed #d4d4d4; display: flex; align-items: center; color: grey;">
                                    <span style="margin-right: 10px;">T&eacute;l&eacute;phone  :</span>
                                    <span class="detail" style="">00000000</span>
                                </li>

                                <li class="list_child" style="border-bottom: 1px dashed #d4d4d4; display: flex; align-items: center; color: grey;">
                                    <span style="margin-right: 10px;">Email  :</span>
                                    <span class="detail" style="">email@gmail.com</span>
                                </li>
